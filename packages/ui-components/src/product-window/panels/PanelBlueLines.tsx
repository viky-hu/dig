...
import { CHAT_LINE_EASE } from "../animation";
...
export function PanelBlueLines({ isActive }: PanelBlueLinesProps) {
  ...
  useLayoutEffect(() => {
    ...
    tl.to(lines, { stroke: CHAT_BLUE, strokeWidth: 1, strokeOpacity: 0.3, duration: 0.8, ease: "sine.inOut" }, 0.7 + SHIFT);
  ...
  return (
    ...
    >
      ...
      <line id="p2-bottom" className="p2-grid-line" x1={P2_V1 + 0.5} y1={P2_BOTTOM + 0.5} x2={P2_V1 + 0.5} y2={P2_BOTTOM + 0.5} />
      <line id="p2-left" className="p2-grid-line" x1={P2_LEFT + 0.5} y1={(P2_TOP + P2_BOTTOM) / 2} x2={P2_LEFT + 0.5} y2={(P2_TOP + P2_BOTTOM) / 2} />
      <line id="p2-right" className="p2-grid-line" x1={P2_RIGHT + 0.5} y1={(P2_TOP + P2_BOTTOM) / 2} x2={P2_RIGHT + 0.5} y2={(P2_TOP + P2_BOTTOM) / 2} />
      <line id="p2-aux-h" className="p2-grid-line" x1={P2_V1 + 0.5} y1={P2_AUX_H_Y + 0.5} x2={P2_V1 + 0.5} y2={P2_AUX_H_Y + 0.5} />
      <g id="p2-quote-tl" className="chat-corner-quote chat-corner-quote-tl" transform={`translate(${CHAT_QUOTE_TL_X} ${CHAT_QUOTE_TL_Y}) scale(${CHAT_QUOTE_SCALE})`}>
        <g className="chat-corner-quote-anim">
          <text className="chat-corner-quote-glyph">{`\u275b\u275b`}</text>
        </g>
      </g>
      <g id="p2-quote-br" className="chat-corner-quote chat-corner-quote-br" transform={`translate(${CHAT_QUOTE_BR_X} ${P2_QUOTE_BR_Y}) scale(${CHAT_QUOTE_SCALE})`}>
        <g className="chat-corner-quote-anim">
          <text className="chat-corner-quote-glyph">{`\u275c\u275c`}</text>
        </g>
      </g>
